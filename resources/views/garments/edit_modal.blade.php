<div class="modal fade" id="edit_garments{{ $garment->id }}">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-center">Edit Garments</h4>
                            ...
                            {{-- <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <input type="text" name="name" required value="{{ $garment->name }}" class="form-control" id="exampleInputEmail1">
                             ...
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <input type="email" name="email" required value="{{ $garment->email }}" class="form-control" id="exampleInputPassword1">
                             ...
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <input type="text" name="phone" required value="{{ $garment->phone }}" class="form-control" id="exampleInputPassword1">
                             ...
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <input type="text" name="licence_no" required value="{{ $garment->licence_no }}" class="form-control" id="exampleInputPassword1">
                             ...
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <input type="text" name="address" required value="{{ $garment->address }}" class="form-control" id="exampleInputEmail1" placeholder="">
