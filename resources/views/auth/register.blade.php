...
<body class="hold-transition register-page">
    <div class="register-box">
        ...
        <div class="card">
            ...
            <div class="card-body register-card-body">
                <p class="login-box-msg">auth a new membership</p>
                ...
                {{-- <div class="social-register-links text-center">
        <p>- OR -</p>
    ...
    <!-- Bootstrap 4 -->
    <script src="{{ asset('admin/auth/js/bootstrapbootstrap.bundle.min.js')}}"></script>
    <!-- AdminLTE App -->
    <script src="{{ asset('admin/auth/js/adminlte.min.js')}}"></script>
</body>
</html>
